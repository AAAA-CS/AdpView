...
from src.systems import image_systems, image_systems_attack
...
SYSTEM = {
    ...
    'PretrainAttackSystem': image_systems_attack.PretrainAttackSystem,
...
if __name__ == "__main__":
    ...
    parser.add_argument('config', type=str, default='config/image/pretrain_viewmaker_cifar10_simclr.json ')
